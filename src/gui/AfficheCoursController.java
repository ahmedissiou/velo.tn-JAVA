...
public class AfficheCoursController implements Initializable {
   ...
   ObservableList<cours> cours = FXCollections.observableArrayList();
    ...
    private void ShowEvaluations(ActionEvent event) {
        ...
        javafx.scene.Parent view = FXMLLoader.load(getClass().getResource("eval.fxml"));
    ...
    private void list(ActionEvent event) {
        ...
        javafx.scene.Parent view = FXMLLoader.load(getClass().getResource("participants.fxml"));
        Scene sceneview = new Scene(view);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(sceneview);
        window.show();
    ...
    private void afficherImage(MouseEvent event) {
      ...
      selectedid = (cours) table.getSelectionModel().getSelectedItem();
       Image image= new Image( "http://localhost//pifinal/pidev/web/images"+selectedid.getNom_image() );
